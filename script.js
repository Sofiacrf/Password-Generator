...
// function with the variables
  function createPassword () {
   ...
   function writePassword () {
        ...
        var containsSpecialCharacters = true; 
        ...
        while (passwordLength >= 8 && passwordLength <= 128) {
            ...
            var userResults = password.slice(0, passwordLength)
            return userResults;
...
document.getElementById("generate").addEventListener("click", () => {
    document.getElementById("password").innerText = ("Your password is now created " + writePassword())
});